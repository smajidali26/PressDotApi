...
namespace PressDot.Facade.Framework.Extensions
{
    /// <summary>
    ...
    public static class MappingExtensions
    {
        ...
        public static TModel ToModel<TModel>(this BaseEntity entity) where TModel : BasePressDotEntityModel
        {
            if (entity == null)
        ...
        /// <param name="entity">Entity to map from</param>
        /// <returns>Mapped model</returns>
        public static ICollection<TModel> ToModel<TModel>(this IEnumerable<BaseEntity> entity) where TModel : BasePressDotEntityModel
        {
        ...
        public static TModel ToModel<TEntity, TModel>(this TEntity entity, TModel model)
            where TEntity : BaseEntity where TModel : BasePressDotEntityModel
        {
            if (entity == null)
                throw new ArgumentNullException(nameof(entity));
        ...
        public static TEntity ToEntity<TEntity>(this BasePressDotEntityModel model) where TEntity : BaseEntity
        {
            if (model == null)
                throw new ArgumentNullException(nameof(model));
        ...
        public static ICollection<TEntity> ToEntity<TEntity>(this IEnumerable<BasePressDotEntityModel> entity) where TEntity : BaseEntity
        {
            var baseEntities = entity?.ToList();
            if (entity == null)
                throw new ArgumentNullException(nameof(entity));
